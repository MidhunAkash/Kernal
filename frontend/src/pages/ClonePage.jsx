    ...
    <div className="shell wide" data-testid="clone-page">
      ...
      <div className="hero-grid">
        ...
        <div className="stack">
          ...
          {/* ── Direct Workspace MCP (humex-workspace) ── */}
          <section className="card" style={{ borderLeft: "3px solid #6366f1" }}>
            <h2 className="mono sm">HumEx Workspace MCP <span className="pill" style={{ fontSize: ".7rem", verticalAlign: "middle" }}>direct</span></h2>
            <p className="helper-text dim">
