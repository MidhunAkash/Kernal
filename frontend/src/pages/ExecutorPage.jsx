      ...
      {!targetOnline && (
        <div className="card" style={{ borderColor: "#f59e0b" }}>
          ...
          <ol className="dim" style={{ fontSize: ".82rem", lineHeight: 1.7, paddingLeft: "1.1rem" }}>
            <li>Confirm the <code>python3 humex_agent.py …</code> process is actually running (terminal should show <code>✓ CONNECTED — job …</code>).</li>
...
function buildPrompt(pub, jobId, apiKey) {
  if (!pub) return "";
  const lines = [
    "You are a senior engineer connected to a remote workspace via the HumEx MCP.",
    "",
    `Problem: ${pub.title}`,
  ];
